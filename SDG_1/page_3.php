	...
	<h1 align="center" style="color: #666666">YOUR INTERNSHIP DETAILS</h1><br>
            ...
            ?>
                    ...
                    <div class="col-lg-12 a" style="color: #333333;"><b>
                        ...
                        ?>    
                            <a href="<?php echo $data['letter']; ?> " target = "_blank"><button class="btn btn-primary">Relieving Letter</button></a><br><br>
                        <?php    
                          }
                        ?>         
                        ...
                        if($curdate >= $mydate && ($data['approval_status'] == 'Approved'))
                        {
                          ...
                          ?> 
                            ...
                            <?php echo $data['feedback'].": "?><a href="feedback_main.php " target = "_blank"  required>Feedback</a><br><br>
