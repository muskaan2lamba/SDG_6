...
<script>
  ...
  <section id=main>
    ...
    <div style='display:none;' id="report">
      <div align="center";>
      <input type="text" name="start_date"  id="start_date" onchange = 'amChanged();' placeholder = "Start Date">      
      <input type="text" name="end_date" id="end_date" onchange = 'amChanged();' placeholder = "End Date"><br><br>    
